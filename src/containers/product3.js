            ...
            >
                <ScrollView>
                    <TouchableOpacity onPress={() => navigation.goBack()} style={{
                        ...
                        />
                        <Text style={{ color: "#000", fontSize: 18, fontWeight: "bold", textAlign: "center" }}>BROSUR</Text>
                    </TouchableOpacity>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
                        <View style={{ margin: 10, marginLeft: 25 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>Brosur A4</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                setSize2(prev => !prev)
                                setSize("Brosur A6")
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>Brosur A6</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ margin: 10, marginLeft: 25, marginRight: 50 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>50 Pcs</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                setPcs2(prev => !prev)
                                setCount("350 Pcs")
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>350 Pcs</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
