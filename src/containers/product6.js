            ...
            >
                <ScrollView>
                    <TouchableOpacity onPress={() => navigation.goBack()} style={{
                        ...
                        />
                        <Text style={{ color: "#000", fontSize: 18, fontWeight: "bold", textAlign: "center" }}>COCARD</Text>
                    </TouchableOpacity>
                    <View style={{ margin: 10, marginLeft: 25 }}>
                        ...
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }}>Cetak 1 Muka</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            setJepit(prev => !prev)
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }}>Cetak 2 Muka</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ margin: 10, marginLeft: 25 }}>
                        ...
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }}>BC TIK</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            setLinen(prev => !prev)
                            setBahan("Linen")
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }}>Linen</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
                        <View style={{ margin: 10, marginLeft: 25 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>5,5 X 8,5</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                setSize2(prev => !prev)
                                setSize("9,5 x 13,5")
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>9,5 x 13,5</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ margin: 10, marginLeft: 25, marginRight: 50 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>25 Pcs</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                setPcs2(prev => !prev)
                                setCount("500 Pcs")
