...
import { View, Text, StyleSheet, TouchableOpacity, Image, TextInput, ImageBackground, PermissionsAndroid, ScrollView } from 'react-native';
            ...
            >
                <ScrollView>
                    <TouchableOpacity onPress={() => navigation.goBack()} style={{
                        ...
                        />
                        <Text style={{ color: "#000", fontSize: 18, fontWeight: "bold", textAlign: "center" }}>KALENDER DINDING</Text>
                    </TouchableOpacity>
                    <View style={{ margin: 10, marginLeft: 25 }}>
                        <Text style={{ color: "#000", fontSize: 20, fontWeight: "bold" }}>Pilihan Finishing</Text>
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }} >Mata Ikan</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            setJepit(prev => !prev)
                            setJenis("Jepit Kaleng")
                        }}>
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }}>Jepit Kaleng</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ margin: 10, marginLeft: 25 }}>
                        ...
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }}>Art Carton 310</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                            setPaper(prev => !prev)
                            ...
                            <Text style={{ color: "#000", fontSize: 14 }}>Art Paper 150</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
                        <View style={{ margin: 10, marginLeft: 25 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>32 X 48</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                setSize2(prev => !prev)
                                setSize("40 x 60")
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>40 X 60</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ margin: 10, marginLeft: 25, marginRight: 50 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>150 Pcs</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                setPcs2(prev => !prev)
                                setCount("500 Pcs")
                                ...
                                <Text style={{ color: "#000", fontSize: 14 }}>500 Pcs</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    <View style={{ marginLeft: 16, marginTop: 15, height: 100 }}>
                        <Text style={{ fontSize: 20, color: "#000", fontWeight: "bold" }}>Catatan:</Text>
                        <TextInput
                            multiline={true}
                            style={{ height: 100, width: "90%", borderWidth: 1, color: "#000" }}
                    ...
                    <View style={{ height: 100, width: "100%", alignItems: "flex-end" }}>
                        <TouchableOpacity onPress={() => createPesanan()} style={{ height: 50, width: "50%", backgroundColor: "#2F632C", alignItems: "center", justifyContent: "center", borderRadius: 25, marginRight:20 }}>
